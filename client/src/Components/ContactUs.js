...
export default function ContactUs() {
  ...
  return (
    <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8 flex items-center">
      <div
        aria-hidden="true"
      ...
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-balance text-10xl font-semibold tracking-tight text-gray-900 sm:text-5xl">Contact sales</h2>
